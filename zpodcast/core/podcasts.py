...
class PodcastList:
    ...
    def update_podcast(
        ...
        url_update = (
            "podcast_url" in data and data["podcast_url"] != podcast.podcast_url
        )
    ...
    def to_dict(self):
        return {"podcasts": [podcast.to_dict() for podcast in self._podcasts]}

    @classmethod
    def from_dict(cls, data):
        podcasts_data = data.get("podcasts", [])
        podcasts = [
            PodcastData.from_dict(podcast_data) for podcast_data in podcasts_data
        ]
