...
@swag_from(
    {
        "responses": {
            200: {"description": "List of all podcasts", "schema": PodcastListSchema},
...
@swag_from(
    {
        ...
        "responses": {
            200: {"description": "Podcast details", "schema": PodcastSchema},
...
@swag_from(
    {
        ...
        "responses": {
            ...
            400: {"description": "Invalid input data or podcast not found"},
            500: {"description": "Server error"},
        },
...
@swag_from(
    {
        ...
        "responses": {
            204: {"description": "Podcast deleted successfully"},
            404: {"description": "Podcast not found"},
            500: {"description": "Server error"},
        },
