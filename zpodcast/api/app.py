...
swagger_template = {
    "info": {
        ...
        "version": "1.0.0",
        "contact": {"name": "ZPodcast Team", "email": "support@zpodcast.example.com"},
    },
    "tags": [
        {"name": "podcasts", "description": "Podcast management operations"},
        {"name": "playlists", "description": "Playlist management operations"},
        {"name": "episodes", "description": "Episode management operations"},
    ],
}
                        ...
                        "properties": {
                            ...
                            "endpoints": {
                                ...
                                "properties": {
                                    "podcasts": {
                                        "type": "string",
                                        "description": "Podcasts endpoint",
                                    },
                                    "playlists": {
                                        "type": "string",
                                        "description": "Playlists endpoint",
                                    },
                                    "episodes": {
                                        "type": "string",
...
class zPodcastApp:
    ...
    def create_app(self, data_dir: str) -> Flask:
        ...
        self.app.config["podcast_list"] = PodcastJSON.import_podcast_list(
            podcast_list_path
        )

        # Load podcast_playlist
        podcast_playlist_path = os.path.join(data_dir, "podcast_playlist.json")
        self.app.config["podcast_playlist"] = PodcastJSON.import_podcast_playlist(
            podcast_playlist_path
        )
