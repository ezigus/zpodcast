...
def test_move_episode_up():
    ...
    episode3 = PodcastEpisode(
        title="Episode 3", audio_url="https://example.com/episode3.mp3"
    )
    playlist = PodcastEpisodeList(
        name="Test Playlist", episodes=[episode1, episode2, episode3]
    )
...
def test_calculate_duration():
    episode1 = PodcastEpisode(
        title="Episode 1", audio_url="https://example.com/episode1.mp3", duration=1800
    )
    episode2 = PodcastEpisode(
        title="Episode 2", audio_url="https://example.com/episode2.mp3", duration=3600
    )
    playlist = PodcastEpisodeList(name="Test Playlist", episodes=[episode1, episode2])
...
def test_get_episodes_specific():
    ...
    episode3 = PodcastEpisode(
        title="Episode 3", audio_url="https://example.com/episode3.mp3", duration=5400
    )
    playlist = PodcastEpisodeList(
        name="Test Playlist", episodes=[episode1, episode2, episode3]
    )
...
def test_retrieve_episodes_from_rss(mocker):
    mock_get_episodes = mocker.patch(
