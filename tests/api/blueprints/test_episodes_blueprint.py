...
def test_podcast_data(mocker, test_episode_data):
    ...
    episode_list = PodcastEpisodeList(
        name="Test Podcast episode list", episodes=test_episode_data
    )
...
def empty_podcast_data(mocker):
    ...
    empty_episode_list = PodcastEpisodeList(
        name="Empty Podcast episode list", episodes=[]
    )
...
def app(mocker, test_podcast_data, empty_podcast_data):
    ...
    mocker.patch(
        "zpodcast.core.podcasts.PodcastList.get_instance", return_value=podcast_list
    )
    mocker.patch(
        "zpodcast.api.blueprints.episodes.PodcastList.get_instance",
